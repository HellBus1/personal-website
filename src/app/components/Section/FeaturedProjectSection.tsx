...
import { SiAndroidstudio, SiBootstrap, SiDart, SiFlutter, SiKotlin, SiLaravel, SiPhp } from "react-icons/si";
...
const FeaturedProjectSection = () => {
    const datas: Project[] = [
        {
            ...
            banner: "https://firebasestorage.googleapis.com/v0/b/personalwebsite-af6e7.appspot.com/o/projects%2Fsasrabahu.png?alt=media&token=eb996cb3-8529-4b8c-9cf0-b54f68189ad6",
            path: "/a/a",
        ...
        },
        {
            ...
            banner: "https://firebasestorage.googleapis.com/v0/b/personalwebsite-af6e7.appspot.com/o/projects%2Fventfit_banner.jpg?alt=media&token=cebdda28-17a3-4077-bae6-9f024a6054a3",
            path: "/a/a",
            createdAt: { seconds: 1680714000, nanoseconds: 384000000 },
        ...
        },
        {
            ...
            name: "VentFit",
            shortDescription: "Ventnote is bmi calculator",
            banner: "https://firebasestorage.googleapis.com/v0/b/personalwebsite-af6e7.appspot.com/o/projects%2Fventnote_banner.jpg?alt=media&token=ea2b43b4-8020-431a-9e8b-ee20339b7eb9",
            path: "/a/a",
            createdAt: { seconds: 1680714000, nanoseconds: 384000000 },
    ...
    return <section className="flex flex-col py-40">
      <div className="mx-40">
                ...
                <div>
                  <div className="text-base flex flex-row mt-4 mb-2 space-x-2 items-center">
                    {item.stacks.map((item) => {
                      return iconMapper[item];
                    })}
                  </div>
                  <div className="text-lg line-clamp-2 text-neutral-content font-bold">{item.name}</div>
